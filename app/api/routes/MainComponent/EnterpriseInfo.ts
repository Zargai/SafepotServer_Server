...
import EnterpriseInfoComponentService from '../../../services/EnterpriseInfo';

const route = Router();

export default (app: Router) => {
    app.use('/enterpriseinfo', route)
    ...
    route.post('/add', async (req: Request, res: Response, next: NextFunction) => {
        ...
        try {
            const { Record } = await ServiceInstance.Add(req.body as IEnterpriseInfoInput);
    ...
    route.post('/update', async (req: Request, res: Response, next: NextFunction) => {
        try {
            const { message, success } = await ServiceInstance.update(req.body as IEnterpriseInfoInput);
    ...
    route.post('/delete', async (req: Request, res: Response, next: NextFunction) => {
        try {
            ...
            const { success } = await ServiceInstance.delete(req.body as IEnterpriseInfoInput);
