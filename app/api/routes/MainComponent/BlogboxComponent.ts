...
import UnitBoxcomponentService from '../../../services/BlogboxComponent';

const route = Router();

export default (app: Router) => {
    app.use('/blogbox', route)
    ...
    route.post('/add', async (req: Request, res: Response, next: NextFunction) => {
        ...
        try {
            const { Record } = await UnitBoxcomponentServiceInstance.Add(req.body as IBlogBoxInput);
    ...
    route.post('/update', async (req: Request, res: Response, next: NextFunction) => {
        try {
            const { message, success } = await UnitBoxcomponentServiceInstance.update(req.body as IBlogBoxInput);
    ...
    route.post('/delete', async (req: Request, res: Response, next: NextFunction) => {
        try {
            ...
            const { success } = await UnitBoxcomponentServiceInstance.delete(req.body as IBlogBoxInput);
